    ...
    var initDatatable = function() {
        ...
        dt = $("#company-profile-datatable").DataTable({
            ...
            columns: [
                ...
                {data   : 'is_contacted',orderable: false,},
                {data   : 'id'},
            ],
            ...
            columnDefs: [
...

                {
                    ...
                    render: function (data) {
                        ...
                        return `<div class="custom-description" title="${data}">${truncatedText}</div>`;
                    }
                },
                // {
                //     searchable: true,
                ...
                //                     <div>
                //                         <div class="text-gray-800 text-hover-primary fs-5 fw-bolder" style="color: #your-desired-color;">
                //                             ${row.name}</i>
                //                         </div>
                //                     </div>
                //                 </div>`;

...
const handleSubmit = () => {
    // Get elements
    form = document.getElementById('create-or-update-room-type-form');
    const submitButton = document.getElementById('create-or-update-room-type-submit');
        ...
        if (validator) {
            validator.validate().then(function (status) {
                ...
                if (status == 'Valid') {
                    ...
                    e.preventDefault();
                    const btn = document.getElementById('create-or-update-room-type-submit');

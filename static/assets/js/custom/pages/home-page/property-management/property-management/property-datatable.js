...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#property-management-datatable").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: true,
            pageLength: 25,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        let truncated_text = data.substring(0, 25)
                        return `<div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="${edit_url}" class="text-gray-800 text-hover-primary fs-5 fw-bolder gift-title" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 200px;display: inline-block;">${truncated_text}</a>
                                    </div>
                                </div>`;
                    }
                },
                {
                    ...
                    orderable: false,
                    render: function (data) {
                        // let truncated_text = data.substring(4, 20)
                        return `
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#property-management-datatable');

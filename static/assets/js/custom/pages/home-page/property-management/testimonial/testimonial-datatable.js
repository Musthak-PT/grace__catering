...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#about-us-datatable").DataTable({
            searchDelay: 500,
            serverSide: true,
            pageLength: 25,
            responsive: false,
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="d-flex align-items-center">
                                    <div class="ms-5">
                                        <a href="${edit_url}" class="text-gray-800 text-hover-primary fs-5 fw-bolder" title="${data}" style="position: relative;" onmouseover="this.style.backgroundColor='white'; this.style.color='black';" onmouseout="this.style.backgroundColor=''; this.style.color='';">${data}</a>
                                    </div>
                                </div>`;
                    }
                },
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#about-us-datatable');

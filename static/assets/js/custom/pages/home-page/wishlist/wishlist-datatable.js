...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#wishlist-datatable").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: true,
            pageLength: 25,
                    ...
                    render: function (data) {
                        return `
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input checkbox-input-id d-none" type="checkbox" value="${data}" />
                            </div>`;
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `<div class="d-flex align-items-center">
                                    <div>
                                        <div class="text-gray-800 text-hover-primary fs-5 fw-bolder" >${row.full_name}</div>
                                    </div>
                                </div>`;
                    }
                },
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#wishlist-datatable');

        ...
        dt = $("#about-us-datatable").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    targets: 4,
                    render: function(data, type, row) {
                        let truncated_text = data.substring(0, 15); // Limit text to 20 characters
                 
                        return `<div class="mt-4 d-flex align-items-center">
                                    <div>
                                        <p class="fs-5 mb-3" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; display: inline-block;">${truncated_text}</p>
                                    </div>
                                </div>`;
                    }
                },
